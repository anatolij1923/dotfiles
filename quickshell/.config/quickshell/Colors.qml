...
QtObject {
    ...
    property color inverse_primary: "#405f91"
    ...
    property color on_primary: "#0a305f"
    
    property color on_primary_container: "#d6e3ff"
    
    property color on_primary_fixed: "#001b3e"
    
    property color on_primary_fixed_variant: "#274777"
    ...
    property color on_tertiary_container: "#f9d8fd"
    ...
    property color primary_container: "#274777"
    
    property color primary_fixed: "#d6e3ff"
    ...
    property color source_color: "#3d79d0"
    ...
    property color tertiary: "#dcbce0"
    
    property color tertiary_container: "#573e5c"
    
    property color tertiary_fixed: "#f9d8fd"
    
    property color tertiary_fixed_dim: "#dcbce0"
